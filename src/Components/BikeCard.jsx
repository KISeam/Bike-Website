    ...
    <>
      <div>
        <div className="flex flex-col gap-4 md:gap-6 p-5 md:p-7 rounded-md bg-[#222222] text-white w-fit transition-all duration-300 group">
          ...
          <div className="w-72 h-44 md:w-96 md:h-64 rounded-lg overflow-hidden">
            <img
              className="group-hover:scale-150 transition-transform duration-1000 w-full h-full object-cover"
              src={images}
              alt={name}
            />
          </div>
          ...
          <div className="flex justify-between items-center border-t border-white/10 pt-4 md:pt-5">
            ...
            <button className="uppercase text-white bg-red-600 hover:bg-red-700 py-2.5 px-6 md:py-3 md:px-8 font-bold cursor-pointer transition-all duration-300 rounded-lg">
              View More
            </button>
          </div>
        </div>
